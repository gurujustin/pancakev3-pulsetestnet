          ...
          {noLiquidity && (
            <AtomBox>
              <Message variant="warning">
                <MessageText>
                  {t(
                    'You are the first liquidity provider for this 9mm Swap V3 pool. Your liquidity will migrate at the current V2 price.',
                  )}
                  <MessageText>
          ...
          {largePriceDifference ? (
            <GreyCard>
              ...
              <Text fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                {t('You should only deposit liquidity into 9mm Swap V3 at a price you believe is correct.')} <br />
                {t(
