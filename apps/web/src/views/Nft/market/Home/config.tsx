  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on 9mm Swap.'),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by 9mm Swap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
