...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">9mm Swap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        9mm Swap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        9mm Swap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        9mm Swap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the 9mm Swap default token list and
        9mm Swap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
