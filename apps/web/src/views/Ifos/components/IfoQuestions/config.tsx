...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active 9mm Swap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active 9mm Swap Profile in order to participate.</Trans>,
    ],
  },
  {
