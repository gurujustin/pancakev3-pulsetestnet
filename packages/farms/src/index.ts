...
const supportedChainId = [ChainId.PULSE_MAINNET, ChainId.BSC, ChainId.BSC_TESTNET, ChainId.ETHEREUM]
const supportedChainIdV3 = [ChainId.PULSE_MAINNET, ChainId.BSC, ChainId.BSC_TESTNET, ChainId.ETHEREUM]
