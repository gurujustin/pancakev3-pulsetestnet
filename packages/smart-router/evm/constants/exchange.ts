...
export const SWAP_ROUTER_ADDRESSES = {
  ...
  [ChainId.PULSE_MAINNET]: '0x99b6ac8Bf3D4268cfB88b706bEBad00F51F3a045',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.PULSE_MAINNET]: [WNATIVE[ChainId.PULSE_MAINNET], USDC[ChainId.PULSE_MAINNET]],
  [ChainId.BSC]: [
    bscTokens.wbnb,
    bscTokens.cake,
    bscTokens.busd,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.PULSE_MAINNET]: [USDC[ChainId.PULSE_MAINNET], WNATIVE[ChainId.PULSE_MAINNET], BUSD[ChainId.PULSE_MAINNET]],
