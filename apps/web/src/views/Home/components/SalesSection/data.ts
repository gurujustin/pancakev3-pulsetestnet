...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('9mm Swap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t(
    'CAKE token is at the heart of the 9mm Swap ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
